...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <title>Blue Duck &middot; Webside Development Northern Ireland</title>
        <meta name="description" content="Magento, WordPress and website developers in Belfast, Northern Ireland. ">
    ...
    <body>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="text-content">
                  ...
                  <span>Magento, WordPress and bespoke web development in Northern Ireland</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-3 col-sm-6">
                <div class="service-item">
                  ...
                  <h4>Development</h4>
                  <p>Magento, WordPress and bespoke website development, making the most or our experience and knowledge to put your project live.</p>
                </div>
              </div>
              <div class="col-md-3 col-sm-6">
                <div class="service-item">
                  ...
                  <h4>Maintenance </h4>
                  <p>Put some life into your website by extending and updating rather than going back to the drawing board, we can help. </p>
                </div>
              </div>
              <div class="col-md-3 col-sm-6">
                <div class="service-item">
                  ...
                  <h4>Consultancy</h4>
                  <p>With over 10 years' experience in website development and ecommerce we can help you navigate through the build process.</p>
                </div>
              </div>
              <div class="col-md-3 col-sm-6">
                <div class="service-item">
                  ...
                  <h4>Training</h4>
                  <p>We can help you make the most of your website with on-site training, video tutorials and user guides.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-10 col-md-offset-1">
                ...
                <div class="right-text col-md-8">
                  <h4><em>Coming Soon</em><br>Nullam volutpat mi vel</h4>
        ...
        <section class="fourth-section" style="display:none; ">
          <div class="container">
            <div class="row">
              <div class="col-md-3 col-sm-6">
        ...
        <section class="fivth-section" style="display:none; ">
          <div class="container">
            <div class="row">
              <div class="col-md-10 col-md-offset-1"> 
        ...
        <section class="sixth-section" style="display:none; ">
          <div class="container">
            <div class="row">
              <div class="col-md-6">
                <div class="row">
          ...
          <div class="container" >
            <div class="row">
              <div class="col-md-12">
                ...
                <p>Copyright &copy; 2019 blueduck.uk</p>
              </div>
            </div>
          </div>
        </footer>
